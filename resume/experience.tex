...
%---------------------------------------------------------
  \cventry
    ...
    {Apr. 2020 - May. 2022} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Used React and static-site paradigms to increase Rising Youth site performance by over 800\%}
...
%---------------------------------------------------------
  \cventry
    ...
    {Library of Mississauga} % Organization
