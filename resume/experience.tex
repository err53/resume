...
%---------------------------------------------------------
  \cventry
    ...
    {TakingITGlobal} % Organization
    {Toronto, Ontario, Canada (Remote)} % Location
    {Apr. 2020 - Dec. 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Used static-site paradigms to increase Rising Youth site performance by over 800\%}
        \item {Revamped core scripts as serverless Firebase Functions to improve availability and maintainability}
        \item {Developed GraphQL and Prisma powered serverless API to interface with sites and mobile apps}
        \item {Created web app using RedwoodJS to provide highly scalable grant administration experiences for over 400+ quarterly applicants}
        ...
        \item {Thrived in fast-paced environment, was able to quickly iterate on concepts and deliver products}
      \end{cvitems}
    }
...
%---------------------------------------------------------
  \cventry
    {Computer Buddies Program Volunteer} % Job title
    {TakingITGlobal} % Organization
    {Mississauga, Ontario, Canada} % Location
    {Jun. 2017 - Sept. 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Worked 1 on 1 with older adults to teach basic computer skills and solve unique problems}
		\item {Helped develop future curriculum for program}
		\item {Worked with administration and other managers to schedule and cover time slots}
      \end{cvitems}
    }
